...
namespace MultiFaceRec
{
    public partial class FaceRecognition : Form
    {
        ...
        {
            const string adminCode = "test"; // Replace with your actual admin code

            try
            {
                if (string.IsNullOrEmpty(textBoxAdminCode.Text) || textBoxAdminCode.Text != adminCode)
                {
                    MessageBox.Show("Invalid admin code. Please enter the correct admin code to add a face.", "Admin Code Required", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return;
                }
                ...
                else
                {
                    ...
                    // Resize face detected image to force comparison with the same size as the test image using cubic interpolation
                    ...
                    // Write the number of trained faces in a text file for further load
                    File.WriteAllText(Application.StartupPath + "/TrainedFaces/TrainedLabels.txt", trainingImages.ToArray().Length.ToString() + "%");

                    // Write the labels of trained faces in a text file for further load
        ...
        void FrameGrabber(object sender, EventArgs e)
        {
            ...
            currentFrame = grabber.QueryFrame().Resize(320, 240, Emgu.CV.CvEnum.INTER.CV_INTER_CUBIC);
                  ...
                  new Size(20, 20));
                    ...
                    if (NamePersons[0] != null && !NamePersons[0].Equals(""))
                    {
                        isRecognized = true;
